...
import co.timetableapp.db.handler.TermHandler;
import co.timetableapp.db.handler.TimetableHandler;
import co.timetableapp.db.query.Filters;
import co.timetableapp.db.query.Query;
import co.timetableapp.db.schema.ClassTimesSchema;
...
import co.timetableapp.ui.adapter.TermsAdapter;
