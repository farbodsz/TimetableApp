...
public class AssignmentsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AssignmentsAdapter(Context context, ArrayList<String> headers,
    ...
    private void setupItemLayout(AssignmentViewHolder holder, int position) {
        ...
        holder.mDueDate.setText(assignment.getDueDate().format(
    ...
    private class AssignmentViewHolder extends RecyclerView.ViewHolder
