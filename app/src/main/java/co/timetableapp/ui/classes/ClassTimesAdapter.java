...
class ClassTimesAdapter extends RecyclerView.Adapter<ClassTimesAdapter.ClassTimesViewHolder> {
    ...
    ClassTimesAdapter(Activity activity, ArrayList<ClassTimeGroup> classTimeGroups) {
        mActivity = activity;
    ...
    class ClassTimesViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
